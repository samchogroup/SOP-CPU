...
__global__ void array_native_kernel(int *&dev_ibead_lj_nat, int *&dev_jbead_lj_nat, int *&dev_itype_lj_nat, int *&dev_jtype_lj_nat, coord *&dev_unc_pos, double *&dev_lj_nat_pdb_dist, int *dev_value, int boxl, int N);
...
__global__ void array_non_native_kernel(int *&dev_ibead_lj_nat, int *&dev_jbead_lj_nat, int *&dev_itype_lj_nat, int *&dev_jtype_lj_nat, coord *&dev_unc_pos, int *dev_value, int boxl, int N);
