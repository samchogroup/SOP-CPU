...
INPUTDIR=/home/anans14/Benchmark/16s/INPUT
OUTPUTDIR=/home/anans14/Benchmark/16s/OUTPUT
...
energy=$(awk '{print $7}' OUTPUT/16s.0.60.2718.$method.$curr.out )
...
do
    ...
    cp $OUTPUTDIR/16s.0.60.2718.$method.$prev.coords.out             $OUTPUTDIR/16s.0.60.2718.$method.$curr.coords.out
    cp $OUTPUTDIR/16s.0.60.2718.$method.$prev.coords_uncorrected.out $OUTPUTDIR/16s.0.60.2718.$method.$curr.coords_uncorrected.out
    cp $OUTPUTDIR/16s.0.60.2718.$method.$prev.velocs.out             $OUTPUTDIR/16s.0.60.2718.$method.$curr.velocs.out
