...
INPUTDIR=/home/anans14/Benchmark/1ehz/INPUT
OUTPUTDIR=/home/anans14/Benchmark/1ehz/OUTPUT
...
energy=$(awk '{print $7}' OUTPUT/1ehz.0.60.2718.$method.$curr.out )
...
do
    ...
    cp $OUTPUTDIR/1ehz.0.60.2718.$method.$prev.coords.out             $OUTPUTDIR/1ehz.0.60.2718.$method.$curr.coords.out
    cp $OUTPUTDIR/1ehz.0.60.2718.$method.$prev.coords_uncorrected.out $OUTPUTDIR/1ehz.0.60.2718.$method.$curr.coords_uncorrected.out
    cp $OUTPUTDIR/1ehz.0.60.2718.$method.$prev.velocs.out             $OUTPUTDIR/1ehz.0.60.2718.$method.$curr.velocs.out
