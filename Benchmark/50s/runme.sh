...
INPUTDIR=/home/anans14/Benchmark/50s/INPUT
OUTPUTDIR=/home/anans14/Benchmark/50s/OUTPUT
...
energy=$(awk '{print $7}' OUTPUT/50s.0.60.2718.$method.$curr.out )
...
do
    ...
    cp $OUTPUTDIR/50s.0.60.2718.$method.$prev.coords.out             $OUTPUTDIR/50s.0.60.2718.$method.$curr.coords.out
    cp $OUTPUTDIR/50s.0.60.2718.$method.$prev.coords_uncorrected.out $OUTPUTDIR/50s.0.60.2718.$method.$curr.coords_uncorrected.out
    cp $OUTPUTDIR/50s.0.60.2718.$method.$prev.velocs.out             $OUTPUTDIR/50s.0.60.2718.$method.$curr.velocs.out
