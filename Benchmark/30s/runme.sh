...
energy=$(awk '{print $7}' OUTPUT/30s.0.60.2718.$method.$curr.out )
...
do
    ...
    cp $OUTPUTDIR/30s.0.60.2718.$method.$prev.coords.out             $OUTPUTDIR/30s.0.60.2718.$method.$curr.coords.out
    cp $OUTPUTDIR/30s.0.60.2718.$method.$prev.coords_uncorrected.out $OUTPUTDIR/30s.0.60.2718.$method.$curr.coords_uncorrected.out
    cp $OUTPUTDIR/30s.0.60.2718.$method.$prev.velocs.out             $OUTPUTDIR/30s.0.60.2718.$method.$curr.velocs.out
